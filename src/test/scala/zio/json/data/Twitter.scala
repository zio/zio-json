...
object Urls {
  implicit val jDecoder: json.Decoder[Urls] = json.MagnoliaDecoder.gen
  implicit val jEncoder: json.Encoder[Urls] = json.MagnoliaEncoder.gen
...
object Url {
  implicit val jDecoder: json.Decoder[Url] = json.MagnoliaDecoder.gen
  implicit val jEncoder: json.Encoder[Url] = json.MagnoliaEncoder.gen
  implicit val customConfig: circe.generic.extras.Configuration =
    circe.generic.extras.Configuration.default
...
object UserEntities {
  implicit val jDecoder: json.Decoder[UserEntities] = json.MagnoliaDecoder.gen
  implicit val jEncoder: json.Encoder[UserEntities] = json.MagnoliaEncoder.gen
  implicit val customConfig: circe.generic.extras.Configuration =
    circe.generic.extras.Configuration.default
...
object UserMentions {
  implicit val jDecoder: json.Decoder[UserMentions] = json.MagnoliaDecoder.gen
  implicit val jEncoder: json.Encoder[UserMentions] = json.MagnoliaEncoder.gen
  implicit val customConfig: circe.generic.extras.Configuration =
    circe.generic.extras.Configuration.default
...
object User {
  implicit val jDecoder: json.Decoder[User] = json.MagnoliaDecoder.gen
  implicit val jEncoder: json.Encoder[User] = json.MagnoliaEncoder.gen
  implicit val customConfig: circe.generic.extras.Configuration =
    circe.generic.extras.Configuration.default
...
object Entities {
  implicit val jDecoder: json.Decoder[Entities] = json.MagnoliaDecoder.gen
  implicit val jEncoder: json.Encoder[Entities] = json.MagnoliaEncoder.gen
  implicit val customConfig: circe.generic.extras.Configuration =
    circe.generic.extras.Configuration.default
...
object Tweet {
  implicit val zioJsonDecoder: json.Decoder[Tweet] = json.MagnoliaDecoder.gen
  implicit val zioJsonEncoder: json.Encoder[Tweet] = json.MagnoliaEncoder.gen
  implicit val customConfig: circe.generic.extras.Configuration =
    circe.generic.extras.Configuration.default
